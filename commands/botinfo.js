...
module.exports = {
    ...
    .setColor('#ff0000')
    .setDescription("**The Punisher** é um bot para Discord inspirado na série The Punisher da Netflix junto com a Marvel. A função do bot é a focada na parte de Moderação e entreterimento, o bot possui varias funções, das mais básicas até as mais complexas.")
