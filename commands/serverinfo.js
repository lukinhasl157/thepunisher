...
module.exports = {
    ...
    let canalAfk = message.guild.afkChannel.replace("null", "Nenhum canal afk.");
    let canalAfkTempo = message.guild.afkChannel.replace("null", "Nenhum tempo.");
        ...
        .addField("» Canal afk:                » Tempo afk:", `${canalAfk}                ${canalAfkTempo}`, true)
        .addField(`<:pensenisso:513802114657419274> » Total de emojis:`, message.guild.emojis.size)
